cordova.define("cordova-plugin-consent.Consent", function(require, exports, module) { 'use strict';
...
var Consent = /** @class */ (function () {
    ...
    Consent.prototype.getConsentStatus = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, execAsync(NativeActions.getConsentStatus)];
                    case 1:
                        n = _a.sent();
    ...
    Consent.prototype.getFormStatus = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, execAsync(NativeActions.getFormStatus)];
                    case 1:
                        n = _a.sent();
    ...
    Consent.prototype.loadForm = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, execAsync(NativeActions.loadForm)];
                    case 1:
                        id = _a.sent();
